...
/// <summary>
/// Adds the WriteTo.TestCorrelator extension methods to <seealso cref="LoggerSinkConfiguration"/>.
/// </summary>
public static class LoggerSinkConfigurationExtensions
{
    /// <summary>
    /// Writes <seealso cref="LogEvent"/>s to a <see cref="TestCorrelatorSink"/>.
    /// </summary>
    /// <param name="loggerSinkConfiguration">The <seealso cref="LoggerSinkConfiguration"/> to write to.</param>
    ...
    public static LoggerConfiguration TestCorrelator(
        ...
        loggerSinkConfiguration.Sink(new TestCorrelatorSink(ids));

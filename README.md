# Serilog.Sinks.TestCorrelator [![CI Build](https://github.com/MitchBodmer/serilog-sinks-testcorrelator/actions/workflows/CI.yml/badge.svg?event=push)](https://github.com/MitchBodmer/serilog-sinks-testcorrelator/actions/workflows/CI.yml) [![NuGet Version](https://img.shields.io/nuget/v/Serilog.Sinks.TestCorrelator)](https://www.nuget.org/packages/Serilog.Sinks.TestCorrelator/) [![NuGet Downloads](https://img.shields.io/nuget/dt/Serilog.Sinks.TestCorrelator.svg)](https://www.nuget.org/packages/Serilog.Sinks.TestCorrelator/)
